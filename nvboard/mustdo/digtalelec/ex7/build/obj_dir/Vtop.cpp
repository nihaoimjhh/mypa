...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , zero1{vlSymsp->TOP.zero1}
    , zero2{vlSymsp->TOP.zero2}
    , outdata{vlSymsp->TOP.outdata}
    , LD{vlSymsp->TOP.LD}
    , count{vlSymsp->TOP.count}
    , count_high{vlSymsp->TOP.count_high}
    , count_low{vlSymsp->TOP.count_low}
    , key_code_high{vlSymsp->TOP.key_code_high}
    , key_code_low{vlSymsp->TOP.key_code_low}
    , ascii_high{vlSymsp->TOP.ascii_high}
    , ascii_low{vlSymsp->TOP.ascii_low}
    , rootp{&(vlSymsp->TOP)}
{
